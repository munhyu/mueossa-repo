...
![ER Diagram](이미지_경로/erd.png)
*(이미지 경로를 실제 이미지 파일 경로로 수정해주세요. 예: ./images/erd.png)*
...
* **팀장 문영휴 (PM, Back-end, 데이터 수집):** 프로젝트 총괄 관리, 백엔드 개발(상품 추천 및 탐색), 데이터 수집 및 전처리
* **팀원 박태영 (Back-end, DB 설계 및 구축):** 백엔드 개발(회원, 비회원, 관리자 기능), 데이터베이스 설계 및 구축, API 개발
* **팀원 이성윤 (Front-end, Back-end):** 프론트엔드 개발, UI/UX 디자인, 일부 백엔드 기능 개발
* **팀원 이현건 (Data Modeling, Back-end):** 데이터 분석 및 모델링, 감성 점수 산출 로직 개발, 일부 백엔드 기능 개발
